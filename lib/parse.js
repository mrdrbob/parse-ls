(function(){
  var toInput, inputNext, inputAtEof, inputCurrentLetter, pass, fail, withErrorMessage, simple, any, char, map, debug, $then, thenKeep, thenIgnore, thenConcat, thenNull, thenArrayConcat, $or, anyOf, many, times, atLeast, atLeastOnce, joinString, sequence, text, maybe, except, doUntil, expectEnd, end, delay, always, alwaysNew, parse, convertRuleToFunction, lineAndColumn;
