(function(){
  var toInput, inputNext, inputAtEof, inputCurrentLetter, pass, fail, withErrorMessage, simple, any, char, map, debug, $then, thenKeep, thenIgnore, thenConcat, thenNull, thenArrayConcat, $or, anyOf, many, joinString, atLeastOnce, sequence, text, maybe, except, doUntil, expectEnd, end, delay, always, parse, convertRuleToFunction, lineAndColumn;
